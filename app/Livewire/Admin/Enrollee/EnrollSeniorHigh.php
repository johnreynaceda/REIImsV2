...
class EnrollSeniorHigh extends Component implements HasForms
{
    ...
    public function mount(){
        ...
        // $this->id_number = StudentInformation::where
    }
    ...
    public function submitPayment(){
        ...
        DB::beginTransaction();
            $student = Student::where('student_information_id', $this->student_id)->first();
            ...
            $student_transaction = StudentTransaction::create([
                ...
                'active_semester' => $this->department == 'SHS' ? '2nd Semester': '1st Semester',
            ]);
